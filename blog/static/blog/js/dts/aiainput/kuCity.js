...
(function($) {
    var allCities = ['五味生活|wuweishenghuo|ww','教育|jiaoyu|jy','政策|zhengce|zc','交通|jiaotong|jt',
    ];
    ...
    KuCity.prototype = {
        ...
        creatItem: function() {
            ...
            var template = '<div class="kucity"><div class="citybox"><h3 class="kucity_header">(温馨贴士：您可以输入省份/城市,也可以选择以下分类搜索)</h3><ul class="kucity_nav"><li class="active">分类</li><li>ABCDEFGH</li><li>IJKLMNOP</li><li>QRSTUVWXYZ</li></ul><div class="kucity_body"></div></div><ul class="result"></ul></div>';
